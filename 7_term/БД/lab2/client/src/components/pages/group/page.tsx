...
import GroupGenre from "./groupGenre";

const GroupConfigurationTable: React.FC<{}> = ({}) => {
    const apiName = "group";
    ...
    return (
        <Box>
            <Typography sx={{ marginBottom: "20px"}} variant="h2">Группа</Typography>

            <Typography sx={{ marginBottom: "20px", maxWidth: "800px"}}>
                На этой странице представлена база всех музыкальных групп
            </Typography>
...
export default memo(GroupConfigurationTable)
