...
const ServiceConfigurationTable: React.FC<{}> = ({}) => {
    ...
    return (
        <Box>
            <Typography sx={{ marginBottom: "20px"}} variant="h2">Services</Typography>

            <Typography sx={{ marginBottom: "20px", maxWidth: "800px"}}>
                На этой странице представлены всевозможные конфигурации сервисов, 
...
export default memo(ServiceConfigurationTable)
